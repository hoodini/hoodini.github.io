...
submitBtn.addEventListener("click", function(event) {
    codeSnippet.textContent = input.value;
...
document.getElementById("submitBtn").addEventListener("click", function() {
    ...
    document.getElementById("codeSnippet").innerHTML = extractedText.slice(0, 50);
    if (option2) {
        document.getElementById("codeSnippet").innerHTML = option1.toLowerCase(), option2.toLowerCase();
    }
});
...
function extractKeyPhrases(text) {
    ...
    let commonWords = ['i', 'my' , 'at', 'you', 'her', 'she', 'they', 'want', 'this', 'that', 'there', 'which', 'who', 'whom', 'whose', 'what', 'whatever', 'when', 'where', 'how', 'why', 'whether', 'her', 'his', 'their', 'if', 'than', 'then'];
    let keyPhrases = [];
